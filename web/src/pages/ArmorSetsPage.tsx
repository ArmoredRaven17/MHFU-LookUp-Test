          ...
          <tbody>
            {v.pieces.map(p => (
              <tr key={p.slot} className="tbl-row">
                <td className="tbl-cell" style={{ minWidth: 22 * scale }}><img src={armorIcon(p.slot, rarity)} alt="" width={22 * scale} height={22 * scale} style={{ objectFit: 'contain', flexShrink: 0 }} onError={e => { (e.target as HTMLImageElement).style.visibility = 'hidden' }} /></td>
